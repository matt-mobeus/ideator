  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="md:hidden fixed inset-0 z-50 flex items-center justify-center bg-[var(--bg-primary)] p-8 text-center">
        <div>
          <h1 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>IDEATOR</h1>
          <p className="text-[var(--text-secondary)]">Please use a desktop or tablet device for the best experience.</p>
        </div>
      </div>
